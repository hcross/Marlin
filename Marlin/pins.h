...
#define HEATER_2_PIN       -1
#define HEATER_BED_PIN     20  // Bed
#define FAN_PIN            22  // Fan (22 for soft-pwm, 16 either)
// You may need to change FAN_PIN to 16 because Marlin isn't using fastio.h
// for the fan and Teensyduino uses a different pin mapping.
  ...
  // GLCD support
    ...
    #define BEEPER           -1
    // Pins for DOGM SPI LCD Support
    #define DOGLCD_A0         28 //orange
    #define DOGLCD_CS         29 //brown
    #define LCD_PINS_D4       30 //purple
    #define LCD_CONTRAST      32
    // Uncomment screen orientation
    // #define LCD_SCREEN_ROT_0
    // #define LCD_SCREEN_ROT_90
    #define LCD_SCREEN_ROT_180
    // #define LCD_SCREEN_ROT_270
  #else // standard Hitachi LCD controller
    #define LCD_PINS_D4       28 //orange
    #define LCD_PINS_D5       29 //brown
    #define LCD_PINS_D6       30 //purple
    #define LCD_PINS_D7       31 //blue
    #define LCD_PINS_RS       32 //white
    #define LCD_PINS_ENABLE   33 //gray
  #endif
