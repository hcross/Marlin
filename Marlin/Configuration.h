...
#define STRING_VERSION_CONFIG_H "2012-09-03" //Personal revision number for changes to THIS file.
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,1511.81102362205,761.328}  // default steps per unit for ultimaker 
