...
#if (THERMISTORHEATER_0 == 81) || (THERMISTORHEATER_1 == 81) || (THERMISTORHEATER_2 == 81) || (THERMISTORBED == 81) // 4k 657-GC1396V-3-200 in SeeMeCNC H-1 kit
// Thermistor lookup table for RepRap Temperature Sensor Boards (http://reprap.org/wiki/Thermistor)
// Made with the online thermistor table generator by Nathan7
// r0: 4000
// t0: 200
// r1: 0
// r2: 4700
...
const short temptable_8[][2] PROGMEM = {
   ...
   {64*OVERSAMPLENR, 345},
   {85*OVERSAMPLENR, 323},
   {106*OVERSAMPLENR, 306},
   {127*OVERSAMPLENR, 293},
   {148*OVERSAMPLENR, 282},
   {169*OVERSAMPLENR, 273},
   {190*OVERSAMPLENR, 265},
   {211*OVERSAMPLENR, 258},
   {232*OVERSAMPLENR, 251},
   {253*OVERSAMPLENR, 245},
   {274*OVERSAMPLENR, 240},
   {295*OVERSAMPLENR, 234},
   {316*OVERSAMPLENR, 229},
   {337*OVERSAMPLENR, 225},
   {358*OVERSAMPLENR, 220},
   {379*OVERSAMPLENR, 216},
   {400*OVERSAMPLENR, 212},
   {421*OVERSAMPLENR, 208},
   {442*OVERSAMPLENR, 205},
   {463*OVERSAMPLENR, 201},
   {484*OVERSAMPLENR, 197},
   {505*OVERSAMPLENR, 194},
   {526*OVERSAMPLENR, 190},
   {547*OVERSAMPLENR, 187},
   {568*OVERSAMPLENR, 183},
   {589*OVERSAMPLENR, 180},
   {610*OVERSAMPLENR, 177},
   {631*OVERSAMPLENR, 173},
   {652*OVERSAMPLENR, 170},
   {673*OVERSAMPLENR, 167},
   {694*OVERSAMPLENR, 163},
   {715*OVERSAMPLENR, 160},
   {736*OVERSAMPLENR, 156},
   {757*OVERSAMPLENR, 152},
   {778*OVERSAMPLENR, 148},
   {799*OVERSAMPLENR, 144},
   {820*OVERSAMPLENR, 140},
   {841*OVERSAMPLENR, 136},
   {862*OVERSAMPLENR, 131},
   {883*OVERSAMPLENR, 126},
   {904*OVERSAMPLENR, 120},
   {925*OVERSAMPLENR, 114},
   {946*OVERSAMPLENR, 106},
   {967*OVERSAMPLENR, 97},
   {988*OVERSAMPLENR, 85},
   {1009*OVERSAMPLENR, 64}
};
#endif
